...
function frontierAnnotationOverlayRuntime(input: Record<string, unknown>) {
  ...
  function ensureUi() {
    ...
    style.textContent = [
      ':host{all:initial}',
      '.frontier-annotation-root{font:13px/1.35 -apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#e5e5e5;letter-spacing:0;--frontier-annotation-radius-shell:18px;--frontier-annotation-radius-nested:14px;--frontier-annotation-radius-control:10px}',
      ...
      '.frontier-annotation-composer{position:relative;display:block;margin:10px;padding:0;border:0;border-radius:var(--frontier-annotation-radius-shell);background:#2b2b2b;box-shadow:none;outline:none}',
      '.frontier-annotation-composer:focus-within{background:#303030;outline:none}',
      '.frontier-annotation-input{box-sizing:border-box;display:block;width:100%;min-height:78px;max-height:164px;resize:none;border:0;border-radius:var(--frontier-annotation-radius-shell);background:transparent;color:#fafafa;padding:13px 54px 45px 14px;font:13px/1.35 -apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;outline:none;overflow-y:hidden}',
